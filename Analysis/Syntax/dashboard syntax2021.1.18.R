...
con <- dbConnect(odbc(),
                 ...
                 Port = 1433)
#########################################################
# Pulling in the SC2 table----
# list of variables to keep from SC2 
sc2_DU_keep <- c("SDASTAND", "SDASEGMT", "SDASERAL", "SCAREFPT", "SCQ090"        
                 , "SCQ040", "SCQ302"  , "SCANLIVE", "SCQ025"  , "SCAISPAN"
                 , "SCAWHERE", "SCARECNT", "SCQ600", "SCQ610"  , "SCQ620"
                 , "SCQ630"  , "SCQ640")
...
ri7_sam_case1_keep <- c("SCACASE", "SDASTAND", "SDASEGMT", "SDASERAL"
                        ,"STAQTYP", "SCAFAMNO", "SCAPERSN", "STARSPNO"
                        , "STAINTUS", "STAPXUSE", "STAPSUSE", "STAINTDT"
                        , "MAQ300")
...
sc3_sam_part_keep <- c("SDASTAND", "SDASEGMT", "SDASERAL", "SCAPARTN"
                       , "SCAFAMNO", "SCAPERSN", "SCQ290A", "SCQ290B"
                       , "SCQ290C", "SCQ131", "SCQ270D", "SCQ260D"
                       , "SCQ302", "SCQCK305", "SCQ291A", "SCQ291B"
                       , "SFQ190", "SCAPRACE", "SCAMARTL")
...
#########################################################
#pull in  the mec exam table----
#QUESTION : What does this table represent
mec_exam <-  dbGetQuery(con, "SELECT * FROM v_mec_exam")

#########################################################
#pull in the family table ----
#QUESTION :What does this table represent-
